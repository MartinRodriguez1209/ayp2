...
function crear (nombre: in string; apellido: in string; dni: in natural; patente: in string) return tipocliente is
...
function cambiarnombre (cliente: in tipocliente; nuevonombre: in string) return tipocliente is
...
function cambiarapellido (cliente: in tipocliente; nuevoape: in string) return tipocliente is
...
function cambiardni (cliente: in tipocliente; nuevodni: in natural) return tipocliente is
...
function cambiarpatente (cliente: in tipocliente; nuevapatente: in string) return tipocliente is
