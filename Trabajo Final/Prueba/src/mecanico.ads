package Mecanico is
   ...
   function Crearmecanico( nombre, apellido, especialidad: string; dni: natural) return Tipomecanico;
   procedure Modificarmecanico(M: in out Tipomecanico; nuevosDatos: tipomecanico; rta: integer);
